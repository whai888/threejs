...
export function export_json_to_excel_multi({
  multiHeader = [],
  header,
  data,
  filename,
...
export function export_json_to_excel_multi2(multiHeader, th, jsonSource, jsonFillter, merges, name ) {
  const data = formatJson(jsonSource, jsonFillter)
  export_json_to_excel_multi({multiHeader, header: th, data, filename: name, merges})
}
